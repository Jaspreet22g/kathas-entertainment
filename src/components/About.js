function About() {
  return (
    <div className="container px-5 mx-auto my-20 overflow-x-hidden max-w-7xl" >
      <div className="flex flex-col items-center justify-around gap-12 py-10 xl:px-16 lg:flex-row rounded-3xl" >
        <div className="max-w-3xl min-w-0" >
          <h4 id="about" className="mb-2 lg:mb-3 xl:mb-4 xl:text-[32px] lg:text-xl text-[#F03E3E] font-semibold text-base">About me!</h4>
